...
use tracer::instruction::{addiw::ADDIW, RISCVCycle};

use super::{CircuitFlags, Flags, InstructionLookup, NUM_CIRCUIT_FLAGS};

impl<const XLEN: usize> InstructionLookup<XLEN> for ADDIW {
    fn lookup_table(&self) -> Option<LookupTables<XLEN>> {
        Some(RangeCheckTable.into())
    }
}

impl Flags for ADDIW {
...
impl<const XLEN: usize> LookupQuery<XLEN> for RISCVCycle<ADDIW> {
